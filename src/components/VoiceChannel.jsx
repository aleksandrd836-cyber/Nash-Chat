            ...
            <div className="flex flex-col gap-3 w-full">
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  className={`py-3 px-4 rounded-xl font-semibold transition-all duration-150 flex items-center justify-center
                    ${isMuted
                ...
                <button
                  ...
                  title={isDeafened ? "Включить звук чата" : "Отключить звук чата"}
                  className={`py-3 px-4 rounded-xl font-semibold transition-all duration-150 flex items-center justify-center
                    ${isDeafened
                      ? 'bg-ds-red/20 border border-ds-red/50 text-ds-red hover:bg-ds-red/30'
                      : 'bg-ds-input hover:bg-ds-hover text-ds-text border border-ds-divider/30'
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl bg-ds-red/15 hover:bg-ds-red/25 text-ds-red border border-ds-red/30 font-semibold transition-all duration-150 flex items-center justify-center gap-2"
                >
