...
export function Sidebar({ 
  ...
  // ── Рендер ──
  return (
    <div className="w-72 flex-shrink-0 flex flex-col z-10 transition-all duration-300 relative select-none vibe-rail vibe-rail--sidebar" onClick={() => { setChanCtx(null); setCtxMenu(null); }}>
      ...
      {/* Server header */}
      <div className="h-14 flex items-center justify-between px-4 flex-shrink-0 transition-colors group border-b border-white/5 bg-white/[0.02]">
        ...
        {isOwner && (
          <button
            ...
            className="w-8 h-8 flex items-center justify-center text-ds-muted hover:text-ds-text transition-colors rounded-xl hover:bg-white/5"
          >
          ...
          <>
            ...
            <div>
              <div className="flex items-center justify-between px-2 mb-1 group">
                <p className="vibe-label-eyebrow">
                  Текстовые каналы
                </p>
                {isOwner && (
                  <button
                    ...
                    className="w-5 h-5 flex items-center justify-center rounded-lg text-ds-muted hover:text-ds-text hover:bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity"
                  >
